...
public sealed partial class Form1 : Form
{
    ...
    public Form1()
    {
        var newPlayerLocation = Point.Empty;
        ...
        playerMoving += (sender, args, picture, offsetValue) =>
        {
            ...
            switch (args.KeyCode)
            {
                case Keys.Up:
                    ...
                    break;
                case Keys.Down:
                    newPlayerLocation.Y = picture.Location.Y + playerSize.Height * 1.60 >= Size.Height ? 0 : offsetValue;
                    break;
                case Keys.Left:
        ...
        {
            Size = playerSize,
            Location = new Point(ClientSize.Width / 2, ClientSize.Height - 77),
        ...
        KeyDown += (sender, args) =>
        {
            playerMoving(sender, args, player, 10);
        };
